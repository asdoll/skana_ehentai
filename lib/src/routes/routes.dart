...
import 'package:skana_ehentai/src/pages/details/details_page.dart';
import 'package:skana_ehentai/src/pages/details/thumbnails/thumbnails_page.dart';
import 'package:skana_ehentai/src/pages/download/download_base_page.dart';
import 'package:skana_ehentai/src/pages/download_search/download_search_page.dart';
import 'package:skana_ehentai/src/pages/gallery_image/gallery_image_page.dart';
import 'package:skana_ehentai/src/pages/gallerys/dashboard/dashboard_page.dart';
...
import 'package:skana_ehentai/src/pages/lock_page.dart';
import 'package:skana_ehentai/src/pages/popular/popular_page.dart';
import 'package:skana_ehentai/src/pages/ranklist/ranklist_page.dart';
import 'package:skana_ehentai/src/pages/read/read_page.dart';
...
import 'package:skana_ehentai/src/pages/setting/about/setting_about_page.dart';
import 'package:skana_ehentai/src/pages/setting/account/cookie/cookie_page.dart';
import 'package:skana_ehentai/src/pages/setting/account/login/login_page.dart';
import 'package:skana_ehentai/src/pages/setting/advanced/setting_advanced_page.dart';
import 'package:skana_ehentai/src/pages/setting/cloud/config_sync/config_sync_page.dart';
import 'package:skana_ehentai/src/pages/setting/cloud/setting_cloud_page.dart';
import 'package:skana_ehentai/src/pages/setting/download/extra_gallery_scan_path/extra_gallery_scan_path_page.dart';
import 'package:skana_ehentai/src/pages/setting/download/setting_download_page.dart';
import 'package:skana_ehentai/src/pages/setting/eh/profile/setting_eh_profile_page.dart';
import 'package:skana_ehentai/src/pages/setting/eh/setting_eh_page.dart';
import 'package:skana_ehentai/src/pages/setting/eh/tagsets/tag_sets_page.dart';
import 'package:skana_ehentai/src/pages/setting/mousewheel/setting_mouse_wheel_page.dart';
import 'package:skana_ehentai/src/pages/setting/network/proxy/setting_proxy_page.dart';
import 'package:skana_ehentai/src/pages/setting/network/setting_network_page.dart';
import 'package:skana_ehentai/src/pages/setting/performance/setting_performace_page.dart';
import 'package:skana_ehentai/src/pages/setting/preference/block_rule/blocking_rule_page.dart';
import 'package:skana_ehentai/src/pages/setting/preference/setting_preference_page.dart';
import 'package:skana_ehentai/src/pages/setting/read/setting_read_page.dart';
import 'package:skana_ehentai/src/pages/setting/security/setting_security_page.dart';
import 'package:skana_ehentai/src/pages/setting/setting_page.dart';
import 'package:skana_ehentai/src/pages/setting/style/setting_style_page.dart';
import 'package:skana_ehentai/src/pages/home_page.dart';
import 'package:skana_ehentai/src/pages/watched/watched_page.dart';
import 'package:skana_ehentai/src/pages/webview/webview_page.dart';
